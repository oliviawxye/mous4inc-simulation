...
FLIGHT_EVENT_TEMPERATURE = 'C'
FLIGHT_EVENT_LEDS = 'C'
FLIGHT_EVENT_MISSION_END = 'M'
FLIGHT_EVENT_AMBIENT = 'C'
FLIGHT_EVENT_PRESSURE = 'C'
...
def run_camera(telemetry):
    ...
    #global PATH_PYTHON3
    #global PATH_HOME
    f_mainlog_w.write(str(datetime.datetime.now()) + "; " + telemetry + "; camera on\n")
    print(str(datetime.datetime.now()) + "; " + telemetry + "; run_camera successful in main.py\n")
    Popen([PATH_PYTHON3, PATH_HOME + 'camera.py'])
...
def run_motor(telemetry):
    ...
    #global PATH_PYTHON3
    #global PATH_HOME
    f_mainlog_w.write(str(datetime.datetime.now()) + "; " + telemetry + "; motor on\n")
    print(str(datetime.datetime.now()) + "; " + telemetry + "; run_motor successful in main.py\n")
    Popen([PATH_PYTHON3, PATH_HOME + 'motor.py'])
...
def run_temperature(telemetry):
    global f_mainlog_w
    global f_temperaturelog_w
    f_mainlog_w.write(str(datetime.datetime.now()) + "; " + telemetry + "; temperature on\n")
    ...
    Popen([PATH_PYTHON3, PATH_HOME + 'temperature.py'])
...
def run_leds(telemetry):
    global f_mainlog_w
    f_mainlog_w.write(str(datetime.datetime.now()) + "; " + telemetry + "; leds on\n")
    print(str(datetime.datetime.now()) + "; " + telemetry + "; run_leds successful in main.py\n")
    Popen([PATH_PYTHON3, PATH_HOME + 'leds.py'])
...
def run_ambient(telemetry):
    global f_mainlog_w
    global f_ambientlog_w
    f_mainlog_w.write(str(datetime.datetime.now()) + "; " + telemetry + "; ambient on\n")
    print(str(datetime.datetime.now()) + "; " + telemetry + "; run_ambient successful in main.py\n")
    f_ambientlog_w.write(str(datetime.datetime.now()) + "; " + telemetry + "\n")
    f_ambientlog_w.close()
    Popen([PATH_PYTHON3, PATH_HOME + 'ambient.py'])
...
def run_pressure(telemetry):
    global f_mainlog_w
    global f_ambientlog_w
    f_mainlog_w.write(str(datetime.datetime.now()) + "; " + telemetry + "; pressure on\n")
    print(str(datetime.datetime.now()) + "; " + telemetry + "; run_pressure successful in main.py\n")
    f_pressurelog_w.write(str(datetime.datetime.now()) + "; " + telemetry + "\n")
    f_pressurelog_w.close()
    Popen([PATH_PYTHON3, PATH_HOME + 'pressure.py'])
...
def main():
    ...
    if os.path.exists(PATH_HOME + "shutdown.txt"):
        os.remove(PATH_HOME + "shutdown.txt")
    ...
    while True:
        try:
            ...
            if (FLIGHT_DATA['flight_event'] == FLIGHT_EVENT_MISSION_END): # M is mission end
                stop_log_files()
                f_shutdown = open(PATH_HOME + "shutdown.txt", "w")
                f_shutdown.close()
